...
- **改进光线追踪渲染管线**
Ambient Occulision, HDR全景照片采集，重要性采样，线性工作流，HDR色调映射, 纹理合成。

- **布料BRDF研究**
研究并设计用于布料渲染的BRDF，研发相关配套工具，配合美工调参。
...
变色算法,基于物理的渲染,人体皮肤渲染,眼球渲染,头发渲染，布料渲染,后期全屏特效 (OGRE, Urho3d, GLSL, GLSLES)
